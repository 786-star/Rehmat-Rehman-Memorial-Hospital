...
const PatientRegisterForm = ({ tokenData, refetch }) => {
    ...
    const tokenHasLastName = tokenData?.patientName?.split(" ").length > 1;
    const tokenHasCNIC = !!tokenData?.CNIC;
    ...
    return (
        <>
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                ...
                <CNICInput control={form.control} name="CNIC" disabled={tokenHasCNIC}/>
            ...
            {patientType === "Indoor Patient" && (
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 pt-3">
