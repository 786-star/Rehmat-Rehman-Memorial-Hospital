    ...
    return (
        <>
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <TextInput label="MRID" control={form.control} name="mrid" placeholder='Enter MRID'/>
                <TextInput label="Name" placeholder="Enter Name" control={form.control} name="firstName" />
                <TextInput label="Father/Husband Name" placeholder="Enter Father/Husband Name" control={form.control} name='lastName' />
